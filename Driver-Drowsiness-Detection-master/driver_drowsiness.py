        ...
        if left_blink == 0 or right_blink == 0:
            ...
            if sleep > 6:
                if status != "SLEEPY":  # Prevent restarting sound if already in this state
                    status = "SLEEPY"
                    color = (0, 0, 255)
                    start_new_sound(r"C:/Users/kosha/OneDrive/Desktop/Driver-Drowsiness-Detection-master/Driver-Drowsiness-Detection-master/sleepy.mp3")
            ...
            if drowsy > 6:
                if status != "DROWSY":  # Prevent restarting sound if already in this state
                    status = "DROWSY"
                    color = (255, 0, 0)
                    start_new_sound(r"C:/Users/kosha/OneDrive/Desktop/Driver-Drowsiness-Detection-master/Driver-Drowsiness-Detection-master/drawsy.mp3")
